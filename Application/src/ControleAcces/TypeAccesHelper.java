...
public class TypeAccesHelper
{
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_tc == null) {
            ...
            _tc = orb.create_alias_tc(id(),"TypeAcces",orb.get_primitive_tc(org.omg.CORBA.TCKind.tk_string));
        }
        return _tc;
    }
    ...
    private final static String _id = "IDL:ControleAcces/TypeAcces:1.0";
